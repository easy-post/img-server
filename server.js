...
app.use(cors({origin:`https://post-react.onrender.com`, allowedHeaders:"Authorization, Content-Type", credentials:true, methods:["GET", "POST", "OPTIONS", "PUT", "PATCH", "DELETE"]}));
